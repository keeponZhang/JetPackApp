...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button?.setOnClickListener {
            val nextAction = R.id.next_other_action
            val flowStepAction = R.id.flow_step_one_dest
            Log.e("TAG", "HomeFragment onViewCreated nextAction=" +nextAction+"  flowStepAction="+flowStepAction);
