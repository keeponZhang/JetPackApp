...
@Entity(tableName = "cache" //表名
        ...
        //ForeignTable表的id列名与Cache的key列名相关
        // ,foreignKeys = {@ForeignKey(entity = ForeignTable.class,parentColumns = "id", childColumns = "key")}
...
public class Cache implements Serializable {
    ...
    /*projection需要查询的哪些字段，parentColumn本表的关联字段*/
    // @Relation(entity = ForeignTable.class,parentColumn = "key",entityColumn = "foreign_key",
    //         projection = {})
    // public ForeignTable foreignTable2;

}



@Entity(tableName = "foreigntable")
 class ForeignTable implements Serializable {
   @PrimaryKey
   @NonNull
