 ...
 * {@link Factory}, where each DataSource created is invalidated when an update to the
...
public abstract class DataSource<Key, Value> {
    ...
    public abstract static class Factory<Key, Value> {
         ...
         */
        @NonNull
        public <ToValue> Factory<Key, ToValue> map(
         ...
         */
        @NonNull
        public <ToValue> Factory<Key, ToValue> mapByPage(
     ...
     *
     * @see #map(Function)
     * @see Factory#map(Function)
     * @see Factory#mapByPage(Function)
     */
    @NonNull
